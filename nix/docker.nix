...
#
# To launch with custom config, mount a dir containing config.yaml and topology,json
#
...
let
  ...
  # Image with all nix-managed network configs or utilizes a configuration volume mount
  ...
  nodeDockerImage = let
    entry-point = writeScriptBin "entry-point" ''
      ...
      ${clusterStatements}
        ...
        echo "Or mount a /configuration volume containing: config.yaml and topology.json"
      fi
    '';
